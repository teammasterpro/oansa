<header class="app-header"><a class="app-header__logo" href="<?php echo base_url('opcionesC/oansa') ?>"><input type=image width="auto" height="50" src="<?= base_url() ?>img/oansaC.png" alt="description" align="Left"></a>
