...
<aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Estadísticas</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" id="opcion" onclick="funcion()" href="<?php echo base_url('opcionesC/asistencias') ?>"><i class="icon fa fa-check"></i> Asistencias</a></li>
            <li><a class="treeview-item" id="opcion" onclick="funcion()" href="https://fontawesome.com/v4.7.0/icons/" target="_blank" rel="noopener"><i class="icon fa fa-bar-chart"></i> Puntaje</a></li>
            <li><a class="treeview-item" id="opcion" onclick="funcion()" href="<?php echo base_url('opcionesC/crecimiento') ?>><i class="icon fa fa-area-chart"></i> Crecimiento</a></li>
          </ul>
        </li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Registrar calificaciones</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" id="opcion" onclick="funcion()" href="<?php echo base_url('opcionesC/calificacionEstudiantes') ?>"><i class="icon fa fa-child"></i> Estudiantes</a></li>
            <li><a class="treeview-item" id="opcion" onclick="funcion()" href="<?php echo base_url('opcionesC/calificacionLideres') ?>"><i class="icon fa fa-user"></i> Lideres</a></li>
          </ul>
        </li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label">Miembros</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" id="opcion" onclick="funcion()" href="<?php echo base_url('opcionesC/miembrosEstudiantes') ?>"><i class="icon fa fa-child"></i> Estudiantes</a></li>
            <li><a class="treeview-item" id="opcion" onclick="funcion()" href="<?php echo base_url('opcionesC/miembrosLideres') ?>"><i class="icon fa fa-user"></i> Lideres</a></li>
          </ul>
        </li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-universal-access"></i><span class="app-menu__label">Responsabilidades</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" id="opcion" onclick="funcion()" href="<?php echo base_url('opcionesC/responsabilidadVer') ?>"><i class="icon fa fa-eye"></i> Ver</a></li>
            <li><a class="treeview-item" id="opcion" onclick="funcion()" href="<?php echo base_url('opcionesC/responsabilidadGestionar') ?>"><i class="icon fa fa-wrench"></i> Gestionar</a></li>
          </ul>
        </li>
            
        <!--Cursos-->
        <li><a class="app-menu__item" id="opcion" onclick="funcion()" href="<?php echo base_url('opcionesC/cursos') ?>"><i class="app-menu__icon fa fa-mortar-board"></i><span class="app-menu__label">Cursos</span></a></li>
        <li><a class="app-menu__item" id="opcion" onclick="funcion()" href="<?php echo base_url('opcionesC/noticias') ?>"><i class="app-menu__icon fa fa-newspaper-o"></i><span class="app-menu__label">Noticias</span></a></li>
        <li><a class="app-menu__item" id="opcion" onclick="funcion()" href="<?php echo base_url('opcionesC/eventos') ?>"><i class="app-menu__icon fa fa-calendar"></i><span class="app-menu__label">Eventos</span></a></li>
        <li><a class="app-menu__item" id="opcion" onclick="funcion()" href="<?php echo base_url('opcionesC/puntajes') ?>"><i class="app-menu__icon fa fa-sort-numeric-desc"></i><span class="app-menu__label">Puntajes</span></a></li>
